...
def dcn(input_tensor, kernel_size, filters, stage, block,
               strides=(2, 2)):
    """dcn is the block that has a conv layer at shortcut
    # Arguments
...
def get_drn_encoder(input_height=224,  input_width=224,
                         pretrained='imagenet',
    ...
    x = dcn(x, 3, [256, 256, 1024], stage=4, block='a')
    ...
    x = dcn(x, 3, [512, 512, 2048], stage=5, block='a')
